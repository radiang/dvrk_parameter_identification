...
def main(ra,max_vel12,max_vel3):
    ...
    state_pub=rospy.Publisher('/dvrk/PSM2/set_robot_state',String,queue_size=10)
    joint_pub= rospy.Publisher('/dvrk/PSM2/set_position_joint', JointState, queue_size=10)
    rospy.Subscriber('/dvrk/PSM2/state_joint_current', JointState, callback_joint)
